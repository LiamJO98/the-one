 ...
 *
 */
public class BlackHoleSprayAndWaitRouter extends ActiveRouter {
	...
	public BlackHoleSprayAndWaitRouter(Settings s) {
		super(s);
	 ...
	 */
	protected BlackHoleSprayAndWaitRouter(BlackHoleSprayAndWaitRouter r) {
		super(r);
	...
	@Override
	public BlackHoleSprayAndWaitRouter replicate() {
