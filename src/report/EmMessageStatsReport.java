 ...
 */
public class EmMessageStatsReport extends Report implements MessageListener {
	...
	@Override
	public void done() {
		write("Message stats for Emeregency Messages scenario " + getScenarioName() +
